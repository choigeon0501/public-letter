...
- 팔레트(우편 소재에서 가져옴): 종이 `#f6f3ec`, 잉크(청흑) `#1e2a3a`, 우표 빨강 `#c8362b`(CTA·강조에만), 항공우편 파랑 `#2f5ea8`(링크·포커스), 크라프트 `#d9c6a5`. 모티프는 항공우편 사선 줄무늬 하나. 헤드라인은 손글씨 폰트(나눔 펜) 자체를 사용. Tailwind v4 `@theme`에 토큰 정의.
